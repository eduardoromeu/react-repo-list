...
export default function BusinessCard(props) {
    ...
    useEffect(() => {
        ...
        ghApi.getUser(username ? username : "eduardoromeu", setUser);
    ...
    useEffect(() => {
        ghApi.getUser(ghApi.currentUserName, setUser);
    }, [ghApi.currentUserName])
    ...
    function changeEmbedTheme(theme){
        ...
        if(theme === "light") {
            embedInput.value = `<embed type="text/html" src="https://eduardoromeu.github.io/react-repo-list/#/card?user=${user.login}&height=100vh&theme=light" title="${user.login}'s Card">`;
        } else {
            embedInput.value = `<embed type="text/html" src="https://eduardoromeu.github.io/react-repo-list/#/card?user=${user.login}&height=100vh&theme=dark" title="${user.login}'s Card">`;
        }
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <InputGroup className="mb-2">
                            ...
                            <FormControl type="text" id="embedInput" defaultValue={`<embed type="text/html" src="https://eduardoromeu.github.io/react-repo-list/#/card?user=${user.login}&height=100vh" title="${user.login}'s Card">`} />
                        </InputGroup>
